...
│   │   ├── localization.js       — Локализация RU/EN
│   │   ├── yandex.js             — Яндекс SDK (автоопределение языка п.2.14)
...
├── CONCEPT.md                     — Концепт-документ (RU/EN)
...
- **Автоопределение языка**: yandexSDK.getEnvironment().i18n.lang (п.2.14)
